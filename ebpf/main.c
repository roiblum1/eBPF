...
int tc_ingress(struct __sk_buff *ctx)
{
    ...
    // Track source MAC with source IP for anomaly detection
    // Note: On ingress from WAN, source MAC will be gateway MAC (normal behavior)
    // The Python layer should filter out gateway MAC addresses
